...
109. **Security Analysis pillar boxes show raw scores** — PRICE: 0/25/50, VOLUME: 0/10/15, VOLATILITY: 0/5/10/15, QUAD: -15 to +20. Labels derived from raw values: PRICE (Aligned/Partial/Neutral), VOLUME (Confirming+/Confirming/Neutral), QUAD (Aligned/Misaligned/Neutral). **VOLATILITY label uses `vix_regime` from backend** (not derived from score) — the same score (+5) maps to different labels depending on viewpoint (Bearish+VIX<19 = "Investable" vs Bullish+VIX 19-23 = "Edgy"). Colors: PRICE green≥50/amber≥25/grey, VOLUME green≥10/grey, VOLATILITY green≥10/amber≥5/grey, QUAD green>0/red<0/grey.
